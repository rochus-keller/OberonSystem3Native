qemu-system-i386 \
  ...
  -append "BootVol=SYS AosFS IDE0;AosFS=OFSDiskVolumes.New OFSAosFiles.NewFS;MT=;MP=;MB=-3;DMASize=14800H;TraceModules=1;Display=;DDriver=DisplayLinear;DMode=00000117H;TraceConsole=1;" \
  -debugcon stdio \
